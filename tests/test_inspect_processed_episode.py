...
class InspectProcessedEpisodeTests(unittest.TestCase):
    def test_summary_for_converted_dummy_episode(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertAlmostEqual(summary["timestamp_span_seconds"], 19.0 / 30.0)
            self.assertAlmostEqual(summary["nominal_frame_coverage_seconds"], 20.0 / 30.0)
            self.assertAlmostEqual(summary["nominal_dt_seconds"], 1.0 / 30.0)
