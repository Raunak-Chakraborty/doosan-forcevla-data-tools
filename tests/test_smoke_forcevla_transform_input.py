...
class SmokeForceVLATransformInputTests(unittest.TestCase):
    def test_module_imports_without_forcevla_import_side_effects(self):
        from doosan_forcevla_data.inspect import smoke_forcevla_transform_input as module

        self.assertTrue(hasattr(module, "build_forcevla_transform_input_report"))
